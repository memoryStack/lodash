...
describe('_inRange(number, start, end)', () => {
  ...
  test('returns true when passed number is equal to start', () => {
    expect(_inRange(1, 1, 4)).toBeTruthy()
  })
  ...
  test('sets start to 0 and end to the value of start argument when end is not passed explicitly', () => {
  ...
  test('always returns false nil values are passed', () => {
    ...
    expect(_inRange(2, 1, NaN)).toBeFalsy()
  })
})
